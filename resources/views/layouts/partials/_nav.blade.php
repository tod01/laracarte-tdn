    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="{{set_active_route('artisan_path')}}"><a href="">Artisan</a></li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="http://larachat.co">Larachat</a></li>
                    </ul>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="http://" target="_blank" rel="noopener noreferrer">Register</a></li>
            </ul>
        </div>
        <!--/.nav-collapse -->
    </div>
